...
const ListCongeAEmployee = () => {
  ...
  const columns = [
    ...
    { field: 'nomprenom', headerName: 'EMPLOYE ', width: 170 },
    { field: 'libelle', headerName: 'TYPE CONGE', width: 220 },
    { field: 'nbrjour', headerName: 'NOMBRE DE JOURS', width: 150 },
  ...
  useEffect(() => {
    axios.get("https://localhost:44367/api/MajCoge/GetCongesAccepterByIdE?matricule=" + localStorage.getItem('MATREmplyee'), config).then((res) => {
...
export default ListCongeAEmployee;