...
function ListAutorisationR() {
    ...
    useEffect(() => {
        axios.get("https://localhost:44367/api/Autorisation/GetAllAutorisationRefuser", config).then((res) => {
    ...
    return (
      ...
      <Grid item>
        <Typography variant="h3" component="h3" gutterBottom>
          Liste des autorisation(s) refusé(s)
        </Typography>
            ...
            <Container maxWidth="xl">
                <Card>
                    <CardHeader style={{ padding: 24 }} sm={{
                        ...
                        title="Liste des autorisation(s) refusé(s)"
                    />
                    <Divider />
                    <CardContent>
...
export default ListAutorisationR;