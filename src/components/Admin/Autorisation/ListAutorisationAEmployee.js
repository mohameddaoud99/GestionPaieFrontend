...
const ListAutorisationAEmployee = () => {
  ...
  useEffect(() => {
    axios.get("https://localhost:44367/api/Autorisation/GetAutorisationAccepterByIdE?matricule=" + localStorage.getItem('MATREmplyee'), config).then((res) => {
...
export default ListAutorisationAEmployee;