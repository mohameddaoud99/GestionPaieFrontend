...
const ListAutorisationREmployee = () => {
  ...
  useEffect(() => {
    axios.get("https://localhost:44367/api/Autorisation/GetAutorisationRefuserByIdE?matricule=" + localStorage.getItem('MATREmplyee'), config).then((res) => {
...
export default ListAutorisationREmployee;